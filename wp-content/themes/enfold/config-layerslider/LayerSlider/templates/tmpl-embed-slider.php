	...
	<div id="ls-embed-modal-window">
		...
		<div class="km-ui-modal-scrollable">
			...
			<div class="ls-separator">
				<div>
					<?php echo sprintf(__('To find more details about how you can embed sliders on your site please refer to our %sonline documetation%s.', 'LayerSlider'), '<a href="https://support.kreaturamedia.com/docs/layersliderwp/documentation.html" target="_blank">', '</a>') ?>
				</div>
			</div>
		</div>
	</div>
